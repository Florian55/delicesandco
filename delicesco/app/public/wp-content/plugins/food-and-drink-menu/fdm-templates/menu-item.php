...
<?php endif; ?>
	...
	<?php else : ?>
	<li<?php echo fdm_format_classes( $this->classes ); ?> data-postid="<?php echo $this->id; ?>" data-section="<?php echo $this->section; ?>" data-timeadded="<?php echo strtotime($this->post->post_date); ?>">
	<?php endif; ?>
