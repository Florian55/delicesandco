...
class fdmDeactivationSurvey {
	...
	public function enqueue_deactivation_scripts() {
		wp_enqueue_style( 'fdm-deactivation-css', FDM_PLUGIN_URL . '/assets/css/plugin-deactivation.css' );
		wp_enqueue_script( 'fdm-deactivation-js', FDM_PLUGIN_URL . '/assets/js/plugin-deactivation.js', array( 'jquery' ) );
		...
		<div class="fdm-deactivate-survey-modal" id="fdm-deactivate-survey-restaurant-menu">
			<div class="fdm-deactivate-survey-wrap">
				<form class="fdm-deactivate-survey" method="post" data-installtime="<?php echo $install_time; ?>">
					...
					<span class="fdm-deactivate-survey-desc"><?php echo __('If you have a moment, please share why you are deactivating Five-Star Restaurant Reservations:', 'food-and-drink-menu' ); ?></span>
